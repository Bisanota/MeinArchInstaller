...
fuentesFonts="ttf-droid ttf-freefont ttf-dejavu ttf-liberation ttf-opensans noto-fonts noto-fonts-cjk noto-fonts-emoji adobe-source-han-sans-otc-fonts noto-fonts-extra inter-font ttf-fira-sans ttf-ms-fonts apple-fonts"
chaoticAURPkgs="epson-inkjet-printer-escpr brave-bin pamac yay onlyoffice-bin"

#otros="netcat"

audio="pipewire wireplumber pipewire-alsa pipewire-pulse pipewire-jack alsa-utils"
# WARNING: I HAVE INTEL, SO, BE CAREFUL WITH THIS PART
video="intel-media-driver libva-intel-driver mesa-utils"
vulkan="vulkan-intel vulkan-tools vulkan-icd-loader lib32-vulkan-icd-loader"
...
fonts="ttf-dejavu noto-fonts noto-fonts-emoji noto-fonts-cjk ttf-droid ttf-freefont ttf-liberation ttf-opensans ttf-jetbrains-mono ttf-jetbrains-mono-nerd ttf-ubuntu-nerd ttf-ubuntu-mono-nerd"
...
openbox="openbox obconf-qt tint2 lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings rofi picom xdg-utils xdg-user-dirs dunst"
...
while true; do
    ...
    echo "1) XFCE 2) LXQt 3) Plasma 4) GNOME 5) Cinnamon 6) MATE 7) Budgie 8) i3 9) Openbox 10) Awesome 11) bspwm 12) Hyprland 13)LabWC"
    read opcion
    case $opcion in
        ...
        13) de=$labwcPKGS; dm="greetd"; break;;
